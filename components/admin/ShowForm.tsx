...
export default function ShowForm({
  ...
  // ⚠️ keepMounted ist hier Pflicht, nicht Geschmack: Alle vier Reiter liegen in
  // EINEM <form>. Ein abgehängter Reiter schickt seine Felder nicht mit, und
  // Speichern würde leeren, was man gerade nicht ansieht. Siehe Tabs.tsx.
  const tabs = [
    {
      id: "text",
      label: "Inhalt",
    ...
    },
    {
      ...
      content: (
        <label className="checkbox-row">
          <input name="is_active" type="checkbox" defaultChecked={show?.is_active ?? true} /> Show ist
  ...
  return (
    <form className="card form" action={formAction}>
      <Tabs tabs={tabs} keepMounted ariaLabel="Show-Einstellungen" />
      {/* Bewusst außerhalb der Reiter: Speichern gehört zum ganzen Formular, nicht
          zum gerade sichtbaren Ausschnitt. */}
